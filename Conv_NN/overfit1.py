...
def main():
    ...
    for loop in range(100):
        ...
        acc, loss = valid_over(data_list[0:10000], nn)
        ...
        acc, loss = train_over(data_list[10000:50000], nn)
    ...
    fig1.plot(range(101), acc_list_v, label="valid", color="blue")
    fig1.plot(range(101), acc_list_t, label="test", color="red")
    fig2.plot(range(101), loss_list_v, label="valid", color="blue")
    fig2.plot(range(101), loss_list_t, label="test", color="red")
    plt.legend()
    plt.show()
...
###
"""
GOT 65.1% TEST ACCURACY
Graph can be seen at 'overfit1_res1.png'
"""
###